...
**Correções aplicadas:**
- ✅ Corrigidos valores do enum `role_nivel` (GESTOR_ADM, GESTOR_SETOR ao invés de GESTOR_ADMINISTRATIVO, etc)
...
**Erro:** `invalid input value for enum user_role_nivel: "GESTOR_ADMINISTRATIVO"`

**Causa:** Migration usava valores antigos do enum (GESTOR_ADMINISTRATIVO, GESTOR_OBRAS, etc)
