...
### FASE 5: Implementar Auto-Save ao Avançar ✅ CONCLUÍDA

#### 5.1 Salvar Dados no Banco
- [x] Criar função `saveStepData(stepId, data)` unificada
- [x] Integrar com Supabase (tabela `ordem_servico_etapas`)
- [x] Adicionar loading state durante salvamento
...
- [x] Spinner no botão "Salvar e Avançar"
...
### FASE 6: Criar Hooks Utilitários ✅ CONCLUÍDA

#### 6.1 useWorkflowState Hook
- [x] Criar hook `useWorkflowState`
- [x] Gerenciar state de todos os steps
- [x] Computed property `completedSteps`
- [x] Helper `getStepData(stepId)`
- [x] Helper `setStepData(stepId, data)`
...
- [x] Criar hook `useWorkflowNavigation`
- [x] Lógica de navegação (next/prev/goto)
- [x] Historical navigation tracking
- [x] Return to active step
...
### FASE 7: Migrar Todos os Workflows ✅ CONCLUÍDA

#### 7.1 Atualizar OS 1-4 (os-details-workflow-page.tsx) ✅ CONCLUÍDA
- [x] Adicionar lógica de `completedSteps` (copiar de OS 5-6)
- [x] Modificar `handleStepClick` para permitir navegação
- [x] Adicionar props necessárias ao WorkflowStepper
- [x] Testar navegação entre etapas
- [x] Testar validação antes de avançar
- [x] Testar salvamento no banco

#### 7.2 Atualizar OS 5-6 (os-details-assessoria-page.tsx) ✅ CONCLUÍDA
- [x] Adicionar modo híbrido (edit/view)
- [x] Adicionar banner de navegação histórica
- [x] Integrar validação obrigatória
- [x] Testar todos os fluxos

#### 7.3 Atualizar OS-08 (os08-workflow-page.tsx) ✅ CONCLUÍDA
- [x] Aplicar padrão unificado
- [x] Testar completude das 7 etapas

#### 7.4 Atualizar OS-09 (os09-workflow-page.tsx) ✅ CONCLUÍDA
- [x] Aplicar padrão unificado
- [x] Testar navegação

#### 7.5 Atualizar OS-13 (os13-workflow-page.tsx) ✅ CONCLUÍDA
- [x] Aplicar padrão unificado
- [x] Testar navegação entre 17 etapas

---

### FASE 8: Componente WorkflowProgressBar ❌ CANCELADA
...
- [ ] ✅ Permite **VOLTAR** para etapas anteriores
- [ ] ❌ **Barra de progresso** visível e funcional (CANCELADO)
- [ ] ✅ **Validação obrigatória** antes de avançar
...
3. **Barra de progresso** - CANCELADA
