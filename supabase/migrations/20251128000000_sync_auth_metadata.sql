-- =====================================================
-- Migration: Sync Colaborador → Auth Metadata
-- Descrição: Cria trigger automático para sincronizar
--            dados de colaboradores para auth.users
-- Data: 2025-11-28
-- =====================================================
...
-- Query para testar se funcionou
-- (Comentado - descomentar para testar manualmente)
/*
SELECT
  c.email,
  c.nome_completo,
  ca.slug as cargo,
  s.slug as setor,
  au.raw_user_meta_data->>'cargo_slug' as meta_cargo,
  au.raw_user_meta_data->>'setor_slug' as meta_setor
