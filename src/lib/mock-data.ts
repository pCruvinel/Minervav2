...
export const mockUsers: User[] = [
  ...
  // ============================================
  {
    ...
    pode_delegar: true,
    pode_aprovar: true,
    setores_acesso: ['ADMINISTRATIVO', 'ASSESSORIA', 'OBRAS'],
    modulos_acesso: {
      administrativo: true,
      financeiro: true,
      operacional: true,
  ...
  {
    id: '2',
    nome_completo: 'Maria Silva Gestora Administrativa',
  ...
  // ============================================
  {
    ...
    setor: 'administrativo',
    supervisor_id: '2',
    supervisor_nome: 'Maria Silva Gestora Administrativa',
    status_colaborador: 'ativo',
...
export const mockOrdensServico: OrdemServico[] = [
  {
    ...
    titulo: 'Projeto Estrutural - Construtora ABC',
  ...
  },
  {
    ...
    titulo: 'Consultoria Técnica - Incorporadora XYZ',
  ...
  },
  {
    ...
    titulo: 'Fiscalização de Obra - Empreendimentos Delta',
  ...
  },
  {
    ...
    tipo: 'Laudo Técnico',
    titulo: 'Laudo Técnico - Construtora Sigma',
  ...
  },
  {
    ...
    titulo: 'Projeto Hidrossanitário - Grupo Omega',
  ...
  },
  {
    ...
    titulo: 'Vistoria Técnica - Incorporadora Beta',
