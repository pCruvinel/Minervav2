...
export const OS_WORKFLOW_STEPS: WorkflowStep[] = [
  ...
  { id: 9, title: 'Gerar Proposta Comercial', short: 'Proposta', responsible: 'Administrativo', status: 'pending' },
  { id: 10, title: 'Agendar Visita (Apresentação)', short: 'Agendar', responsible: 'Administrativo', status: 'pending' },
  { id: 11, title: 'Realizar Visita (Apresentação)', short: 'Apresentação', responsible: 'Administrativo', status: 'pending' },
  { id: 12, title: 'Follow-up 3 (Pós-Apresentação)', short: 'Follow-up 3', responsible: 'Administrativo', status: 'pending' },
  { id: 13, title: 'Gerar Contrato (Upload)', short: 'Contrato', responsible: 'Administrativo', status: 'pending' },
  { id: 14, title: 'Contrato Assinado', short: 'Assinatura', responsible: 'Administrativo', status: 'pending' },
