...
import { StepAberturaSolicitacao } from './steps/os10/step-abertura-solicitacao';
import { StepSelecaoCentroCusto } from './steps/os10/step-selecao-centro-custo';
import { StepSelecaoColaborador } from './steps/os10/step-selecao-colaborador';
import { StepDetalhesVaga } from './steps/os10/step-detalhes-vaga';
import { StepRequisicaoMultipla } from './steps/os10/step-requisicao-multipla';
...
export function OS10WorkflowPage({ onBack, osId }: OS10WorkflowPageProps) {
    ...
    const completionRules = useMemo(() => ({
        ...
        5: (data: any) => true, // Opcional - múltipla requisição
    }), []);
