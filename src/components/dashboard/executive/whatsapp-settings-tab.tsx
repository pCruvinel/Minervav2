/**
 * WhatsAppSettingsTab - Configuração do WhatsApp via Evolution API
 *
 * Permite configurar URL e API Key da Evolution API,
 * criar/conectar instância via QR Code e verificar status.
 */
'use client';
...
export function WhatsAppSettingsTab() {
    ...
    const handleSaveSettings = async () => {
        ...
        try {
            ...
            logger.error('[WhatsAppSettingsTab] Error saving settings:', err);
    ...
    const handleCheckStatus = async () => {
        ...
        try {
            ...
            logger.log('[WhatsAppSettingsTab] Instance status:', status);
            ...
            logger.error('[WhatsAppSettingsTab] Error checking status:', err);
    ...
    const handleConnect = async () => {
        ...
        try {
            ...
            try {
                ...
                logger.log('[WhatsAppSettingsTab] Instance created');
            } catch (createErr) {
                // Instance might already exist, continue
                logger.log('[WhatsAppSettingsTab] Instance might already exist:', createErr);
            }

            // Get QR Code
            const qrResponse: QrCodeResponse = await makeApiRequest(`/instance/connect/${instanceName}`);
            logger.log('[WhatsAppSettingsTab] QR Response:', qrResponse);
            ...
            logger.error('[WhatsAppSettingsTab] Error connecting:', err);
    ...
    const handleDisconnect = async () => {
        ...
        try {
            ...
            logger.error('[WhatsAppSettingsTab] Error disconnecting:', err);
