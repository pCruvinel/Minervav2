...
```
1. Login como: vendedor.1@minerva.com (COLABORADOR_COMERCIAL)
2. Observar: Menu mostra apenas 4 itens
3. Logout
4. Login como: maria.silva@minervaengenharia.com.br (GESTOR_COMERCIAL)
